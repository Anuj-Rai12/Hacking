...
import kotlinx.android.synthetic.main.fragment_weekly2.*
...
class WeeklyFragment : Fragment(), AllTodosRecyclerAdapter.AllTodosListener {
    ...
    override fun onCreateView(
        ...
        uiScope.launch {
            ...
            recyclerView.adapter = AllTodosRecyclerAdapter(arrayList, this@WeeklyFragment)
    ...
    override fun onClickAllTodos(position: Int) {
        findNavController().navigate(
            AllTodosViewPagerFragmentDirections.actionAllTodosViewPagerFragmentToTodoDetailsFragment(
