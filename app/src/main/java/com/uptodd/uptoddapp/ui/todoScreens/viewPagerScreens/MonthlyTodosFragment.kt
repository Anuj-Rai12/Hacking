...
import com.uptodd.uptoddapp.databinding.FragmentMonthlyTodosBinding
...
class MonthlyTodosFragment : Fragment(), TodosRecyclerAdapter.TodosInterface {

    private lateinit var binding: FragmentMonthlyTodosBinding
    ...
    override fun onResume() {
        super.onResume()
        viewModel.loadMonthlyTodoScore()
    }
    ...
    override fun onCreateView(
        ...
        viewModel.monthlyPendingTodosList.observe(viewLifecycleOwner, {
            it?.let {
                if (it.size == 1) {
...
//            return DateClass().isTodoFresh(lastTodoFetchedOn)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnDone.setOnClickListener {
            ...
            viewModel.markAllMonthlyAsComplete(
                todosRecyclerAdapter.selectedItemList,
                requireContext()
            )

            viewModel.multipleMonthlySelectionTaskCompleteFlag.observe(viewLifecycleOwner, {
                if (it == true) {
                    todosRecyclerAdapter.clearAllSelected()
                    viewModel.multipleMonthlySelectionTaskComplete()
                    viewModel.multipleMonthlySelectionTaskCompleteFlag.removeObservers(
                        viewLifecycleOwner
                    )
                }
            })
    ...
    private fun initialiseBindingAndViewModel(inflater: LayoutInflater, container: ViewGroup?) {
        ...
        binding =
            DataBindingUtil.inflate(inflater, R.layout.fragment_monthly_todos, container, false)
    ...
    private fun initialiseRecyclerView() {
        ...
        viewModel.monthlyPendingTodosList.observe(viewLifecycleOwner, { todosList ->
            todosList.let { it ->
