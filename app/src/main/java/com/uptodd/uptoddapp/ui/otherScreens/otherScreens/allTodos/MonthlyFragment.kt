...
import kotlinx.android.synthetic.main.fragment_monthly2.*
...
class MonthlyFragment : Fragment(), AllTodosRecyclerAdapter.AllTodosListener {
    ...
    override fun onCreateView(
        ...
        uiScope.launch {
            ...
            recyclerView.adapter = AllTodosRecyclerAdapter(arrayList, this@MonthlyFragment)
