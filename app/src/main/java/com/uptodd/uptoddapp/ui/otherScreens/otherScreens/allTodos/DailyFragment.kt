...
import kotlinx.android.synthetic.main.fragment_daily2.*
...
class DailyFragment : Fragment(), AllTodosRecyclerAdapter.AllTodosListener {
    ...
    override fun onCreateView(
        ...
        uiScope.launch {
            ...
            recyclerView.adapter = AllTodosRecyclerAdapter(arrayList, this@DailyFragment)
