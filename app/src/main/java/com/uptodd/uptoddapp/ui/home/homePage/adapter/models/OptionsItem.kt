...
data class OptionsItem(var navId: Int, var icon: Int, var title: String) {
    ...
    companion object {
        ...
        fun getFreeDemoSection(): ArrayList<OptionsItem> {
            ...
            arrayList.add(
                OptionsItem(R.id.action_freeDemoBashBoardFragment_to_demoVideoContentFragment, R.drawable.app_icon, "Video Content"))
            arrayList.add(OptionsItem(R.id.action_freeDemoBashBoardFragment_to_toolKitAndReviewFragment, R.drawable.app_icon, "Reviews"))
            arrayList.add(OptionsItem(R.id.action_freeDemoBashBoardFragment_to_toolKitAndReviewFragment, R.drawable.app_icon, "Course Tool kit"))
            arrayList.add(OptionsItem(0, R.drawable.app_icon, "Upgrade"))
            arrayList.add(OptionsItem(0, R.drawable.app_icon, "Mentor"))
            arrayList.add(OptionsItem(0, R.drawable.app_icon, "FAQ"))
            return arrayList
        }
        ...
        fun getPersonalizedList(): ArrayList<OptionsItem> {
            ...
            optionsItem.apply {
                ...
                add(
                    OptionsItem(
                        R.id.action_homePageFragment_to_allTodosViewPagerFragment,
                ...
                add(
                    OptionsItem(
                        R.id.action_homePageFragment_to_music,
        ...
        fun getPremiumList(): ArrayList<OptionsItem> {
            ...
            optionsItem.apply {
                add(
                    OptionsItem(
                        R.id.action_homePageFragment_to_homeExpertCounselling,
                ...
                add(
                    OptionsItem(
                        R.id.action_homePageFragment_to_referFragment,
                ...
                add(
                    OptionsItem(
                        R.id.action_homePageFragment_to_tutorialFragment,
                ...
                add(
                    OptionsItem(
                        R.id.action_homePageFragment_to_webinarFragment,
                ...
                add(
                    OptionsItem(
                        R.id.action_homePageFragment_to_recipeFragment,
                ...
                add(
                    OptionsItem(
                        R.id.action_homePageFragment_to_developmentTrackerFragment,
        ...
        fun getParentToolList(): ArrayList<OptionsItem> {
            ...
            optionsItem.apply {
                add(
                    OptionsItem(
                        R.id.action_homePageFragment_to_poemFragment,
                ...
                add(
                    OptionsItem(
                        R.id.action_homePageFragment_to_storiesFragment,
                ...
                add(
                    OptionsItem(
                        R.id.action_homePageFragment_to_dietFragment,
                ...
                add(
                    OptionsItem(
                        R.id.action_homePageFragment_to_toysFragment,
                ...
                add(
                    OptionsItem(
                        R.id.action_homePageFragment_to_expectedOutcomesFragment3,
                ...
                add(
                    OptionsItem(
                        R.id.action_homePageFragment_to_editAlarmsViewPagerFragment,
                        R.drawable.ic_routine_alaram, "Routine Alarm"
                    )
                )
                add(
                    OptionsItem(
                        R.id.action_homePageFragment_to_allTicketsFragment,
                        R.drawable.ic_support, "Support"
                    )
                )
                add(
                    OptionsItem(
                        R.id.action_homePageFragment_to_blogsFragment,
